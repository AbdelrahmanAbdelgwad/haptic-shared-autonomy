...
if __name__ == "__main__":
    ...
    if LOAD_MODEL:
        model = th.load("trials/models/DQN_Lunar_Shared_alpha_0.4_with_pretrained_model_as_pilot_workstation")
        agent.Q_pred = model
    ...
    for i in range(n_games):
        ...
        plt.savefig(f"trials/graphs/training_using_alpha_0.4_workstation.png")
